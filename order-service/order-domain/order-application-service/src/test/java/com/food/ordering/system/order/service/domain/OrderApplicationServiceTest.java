...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("c192a033-1dbe-49f3-8103-9747b5004842");
    private final UUID RESTAURANT_ID = UUID.fromString("e372371f-8d2d-4b54-88c9-5913a9350d22");
    private final UUID PRODUCT_ID = UUID.fromString("6059783f-25bb-474d-bb05-d339c714ef58");
    private final UUID ORDER_ID = UUID.fromString("840cc0ca-e981-4c7c-b0db-92d64eed7880");
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        Assertions.assertEquals("Total price: 250.00 is not equal to Order items " +
                "total: 200.00!", orderDomainException.getMessage());
    ...
    public void testCreatedOrderWithPassiveRestaurant() {
        ...
        Mockito.when(restaurantRepository.findRestaurantInformation(
                orderDataMapper.createOrderCommandToRestaurant(createOrderCommand))).thenReturn(Optional.of(restaurantPassive));
